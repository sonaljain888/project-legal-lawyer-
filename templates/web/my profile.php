        ...
        <div class="row">
            <div class="col-sm-9 padding-right">
                <div class="category-tab" ><!--category-tab-->
                    ...
                    <a href="" style="margin-left: 10%"><input type="button"  name="button" value="Law Firm" style="background:  #a91b0c;color: white;"/></a>
                    <a href="" style="margin-left: 2%"><input type="button"  name="button" value="Judge" style="background:  #a91b0c;color: white;"/></a>
