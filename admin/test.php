...
<?php
$page_id = $category_id = $page_name = $url = $top_description = $bottem_description =
$keyword = $title = $discription = $author = $modified = $access_type = $page_status = $error = "";
if(strlen(Request::post("submit"))){
    ...
    $bottem_description = Request::post("bottem_description");
    ...
    $pageObj->set("bottem_description", $bottem_description);
    $pageObj->set("keyword", $keyword);
    $pageObj->set("title", $title);
    $pageObj->set("discription", $discription);
    $pageObj->set("author", $author);
    $pageObj->set("modified", $modified);
                        ...
                        <div class="box-content">
                            ...
                            if(is_numeric($id) && $id > 0){
                                ...
                                if(count($result)){
                                    ...
                                    $bottem_description= $row['bottem_description'];
                                    $keyword= $row['Keyword'];
                                    $title= $row['title'];
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" >
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="input-group">
                                                    <textarea  id="description" name="bottem_description" value="<?php echo $bottem_description ;?>">
                                                    </textarea>
                                                    <script>
                                                        CKEDITOR.replace('bottem_description');
                                                    </script>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="input-group" >
                                                    <textarea  id="description" name="discription" value="<?echo $discription; ?>">
                                                    </textarea>
                                                    <script>
                                        ...
                                        <tr>
                                            <td ><label class="control-label" for="selectError">Author</label> </td>
                                            <td>
                                                <div class="input-group" >
                                                    <span class="input-group-addon"></span>
                                                    <input type="text" name="author" value="<?php echo $author; ?>" class="form-control" placeholder="Title" required="">
                                                </div> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td ><label class="control-label" for="selectError">Modified By</label> </td>
                                            <td>
                                                <div class="input-group" >
                                                    <span class="input-group-addon"></span>
                                                    <input type="text" name="modified" value="<?php echo $modified; ?>" class="form-control" placeholder="Title" required="">
                                                </div> 
                                            </td>
                                        </tr>
                                        <tr>
